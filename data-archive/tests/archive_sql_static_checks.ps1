...
Assert-Match $examples 'p_retention_periods\s+=>\s+6' 'full retention-periods example'
...
Assert-Match $readme 'p_retention_periods\s+=>\s+6' 'README main full retention-periods example'
...
Assert-Contains $readme (Decode-Base64Utf8 '5YWo6YeP5ZCM5q2l5Zyo5Yib5bu65b2S5qGj6KGo5ZKM5aSN5Yi25pWw5o2u5YmN5bCx5Lya5oql6ZSZ') 'README unsupported source partition fails before copy'
...
Assert-Match $readme 'p_retention_periods\s+=>\s+2' 'README cutover retention-periods example'
Assert-Match $readme 'p_batch_days\s+=>\s+1' 'README full batch-days example'
Assert-Contains $readme (Decode-Base64Utf8 '5q+P5Liq5om55qyh5oiQ5Yqf5ZCO56uL5Y2z5o+Q5Lqk') 'README full per-batch commit semantics'
...
Assert-Contains $readme (Decode-Base64Utf8 '5LiN6KaB5Zyo5bey57uP5b2S5qGj5aKe6YeP56qX5Y+j5ZCO77yM5YaN5qyh5omn6KGM5oiq5q2i6IyD5Zu06YeN5Y+g55qE5YWo6YeP5ZCM5q2l77yM5Zug5Li65b2T5YmN54mI5pys5LiN5YGa5Y676YeN44CC') 'README no overlapping full sync warning'
